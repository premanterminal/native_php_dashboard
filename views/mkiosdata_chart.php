...
switch($_GET['pilih'])
{
    ...
    try
	{
        ...
        ");
		$stmt->execute();
		$mkiosdata = $stmt->fetchAll(PDO::FETCH_ASSOC);
...
<main>
	<section class="pb-4">
        <div class="card">
        	<h3 class="card-header black white-text">MKIOS DATA <?Php echo $newdate;  //foreach ($tgl_vlr as $data) {print $data['tgl']. "\n";} ?> DESEMBER 2018</h3>
            <div class="card-body">
				<div class="row" align="center">
				<div class="col-lg-6 col-md-12">
                		<select id="branch_mkiosdata_inc" name="branch_mkiosdata_inc" class="mdb-select" required>
                	...
                	<div class="col-lg-6 col-md-12">
                        <select id="cluster_mkiosdata_inc" name="cluster_mkiosdata_inc" class="mdb-select" required disabled>
                            <option value="" disabled selected>Pilih Cluster</option>
                        </select>
                	</div></div>
				<div id="script_mkiosdata_inc" style="margin: 0 auto"></div>	
				<div class="table-responsive fixed-table-body">
					<table class="collaptable table table-responsive table-sm table-striped mb-0" >
						<thead class="mdb-color darken-4">
							<tr id="tanggal_mkiosdata" style="border:1px solid black">
						...
						<tbody>
							...
							<tr id="mkiosdata_d5">
								...
								<td style="font-size:11px"><?= number_format($data['1']) ?></td>
								<td style="font-size:11px"><?= number_format($data['2']) ?></td>
								<td style="font-size:11px"><?= number_format($data['3']) ?></td>
								<td style="font-size:11px"><?= number_format($data['4']) ?></td>
								<td style="font-size:11px"><?= number_format($data['5']) ?></td>
								<td style="font-size:11px"><?= number_format($data['6']) ?></td>
								<td style="font-size:11px"><?= number_format($data['7']) ?></td>
								<td style="font-size:11px"><?= number_format($data['8']) ?></td>
								<td style="font-size:11px"><?= number_format($data['9']) ?></td>
								<td style="font-size:11px"><?= number_format($data['10']) ?></td>
								<td style="font-size:11px"><?= number_format($data['11']) ?></td>
								<td style="font-size:11px"><?= number_format($data['12']) ?></td>
								<td style="font-size:11px"><?= number_format($data['13']) ?></td>
								<td style="font-size:11px"><?= number_format($data['14']) ?></td>
								<td style="font-size:11px"><?= number_format($data['15']) ?></td>
								<td style="font-size:11px"><?= number_format($data['16']) ?></td>
								<td style="font-size:11px"><?= number_format($data['17']) ?></td>
								<td style="font-size:11px"><?= number_format($data['18']) ?></td>
								<td style="font-size:11px"><?= number_format($data['19']) ?></td>
								<td style="font-size:11px"><?= number_format($data['20']) ?></td>
								<td style="font-size:11px"><?= number_format($data['21']) ?></td>
								<td style="font-size:11px"><?= number_format($data['22']) ?></td>
								<td style="font-size:11px"><?= number_format($data['23']) ?></td>
								<td style="font-size:11px"><?= number_format($data['24']) ?></td>
								<td style="font-size:11px"><?= number_format($data['25']) ?></td>
								<td style="font-size:11px"><?= number_format($data['26']) ?></td>
								<td style="font-size:11px"><?= number_format($data['27']) ?></td>
								<td style="font-size:11px"><?= number_format($data['28']) ?></td>
								<td style="font-size:11px"><?= number_format($data['29']) ?></td>
								<td style="font-size:11px"><?= number_format($data['30']) ?></td>
								<td style="font-size:11px"><?= number_format($data['31']) ?></td>
							</tr>
							<?php
								$i++;
							}
			...
			<div class="card-body">
					<font> 
						<b><center>Berikut Growth Mkios Data update s/d <?php
...
<?php
	...
	<section class="pb-4">
        <div class="card">
		        	<!--<h3 class="card-header black white-text">MKIOS DATA PERFORMANCE 1-<?php //echo"$newdate"?> DESEMBER 2018</h3>-->
					<h3 class="card-header black white-text">MKIOS DATA PERFORMANCE <?php echo $newdate; ?> DESEMBER 2018</h3>
				<div class="card-body">
				
            	<table class="table table-responsive" id="dataTables">
				<br><b><center>
				Untuk Detail Performance Mkiosdata peroutlet silahkan download di link berikut	
				<a href="http://10.33.97.177/tiramisu/autoemail_mcd/mkiosdata_outlet_export.php">
				Download
				</a></b></center>
