	...
	// Fungsi Dropdown Chart Script Region C (Chart Region Sompare)
		...
		$('#branch_mkiosdata_inc').on('change', function() {
				...
				success : function(data)
				{
					...
					script_mkiosdata_inc.series[2].setData(mkiosdata_d5_lastmonth_inc, true);
				...
				success : function(data)
				{
					...
					script_mkiosdata_inc.series[4].setData(mkiosdata_d10_lastmonth_inc, true);
				...
				success : function(data)
				{
					...
					script_mkiosdata_inc.series[6].setData(mkiosdata_d20_lastmonth_inc, true);
				...
				success : function(data)
				{
					...
					script_mkiosdata_inc.series[8].setData(mkiosdata_d25_lastmonth_inc, true);
				...
				success : function(data)
				{
					...
					script_mkiosdata_inc.series[10].setData(mkiosdata_d50_lastmonth_inc, true);
				...
				success : function(data)
				{
					...
					script_mkiosdata_inc.series[12].setData(mkiosdata_d100_lastmonth_inc, true);
				...
				success : function(data)
				{
					...
					script_mkiosdata_inc.series[3].setData(mkiosdata_d5, true);
				...
				success : function(data)
				{
					...
					script_mkiosdata_inc.series[5].setData(mkiosdata_d10, true);
				...
				success : function(data)
				{
					...
					script_mkiosdata_inc.series[7].setData(mkiosdata_d20, true);
				...
				success : function(data)
				{
					...
					script_mkiosdata_inc.series[9].setData(mkiosdata_d25, true);
				...
				success : function(data)
				{
					...
					script_mkiosdata_inc.series[11].setData(mkiosdata_d50, true);
				...
				success : function(data)
				{
					...
					script_mkiosdata_inc.series[13].setData(mkiosdata_d100, true);
        ...
        $(document).ready(function () {
            ...
            $('#bulan_scripty').on('change', function() {
                ...
                var last_year_y = [14, 50, 75, 34, 56, 23, 24, 56, 78, 50, 14, 50, 75, 34, 56, 23, 24, 56, 78, 50, 14, 50, 75, 34, 56, 23, 24, 56, 78, 50, 31];
                var now_y = [100, 112, 0, 0, 360, 330, 141, 150, 100, 0, 0, 0, 10, 12, 60, 70, 60, 300, 101, 100, 100, 67, 110, 10, 101, 100, 100, 67, 80, 66];
                var last_month_y = [10, 12, 60, 70, 60, 300, 101, 100, 100, 67, 110, 10, 100, 112, 0, 0, 360, 330, 141, 150, 100, 2, 7.5, 8, 8.2, 9, 11, 7, 18, 21, 7];

                Ini contoh insert data baru ke dalam chart 
                scripty.series[0].setData(eval(last_year_y), false, true); // insert data des
                scripty.series[1].setData(eval(now_y), false, true); // insert data mom
                scripty.series[2].setData(eval(last_month_y), false, true); // insert data yoy

                scripty.xAxis[0].setCategories(tanggal, true, true); // insert data kategori chart*/
